...
let ustring_of_sexp sx =
  let us = string_of_sexp sx in
  BatUTF8.validate us;
  us

let sexp_of_ustring us = sexp_of_string us
...
let of_wstring s = WStringValue (BatUTF8.validate s; s)
...
let to_wstring = function WStringValue v -> v | _ -> failwith "to_wstring"
