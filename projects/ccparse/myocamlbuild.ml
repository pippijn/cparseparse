(* OASIS_START *)
(* DO NOT EDIT (digest: ad381254acbc7fac0763609cbc87a6b0) *)
...
# 21 "/home/pippijn/code/wip/oasis/src/oasis/OASISExpr.ml"
...
# 21 "/home/pippijn/code/wip/oasis/src/base/BaseEnvLight.ml"
...
# 21 "/home/pippijn/code/wip/oasis/src/plugins/ocamlbuild/MyOCamlbuildFindlib.ml"
...
# 21 "/home/pippijn/code/wip/oasis/src/plugins/ocamlbuild/MyOCamlbuildBase.ml"
...
# 56 "/home/pippijn/code/wip/oasis/src/plugins/ocamlbuild/MyOCamlbuildBase.ml"
...
let package_default =
  {
     ...
     includes =
       [
          ...
          ("src/ccparse/tok",
            ["src/ccabs"; "src/ccparse"; "src/ccparse/gr"; "src/ccparse/ml"]);
          ("src/ccparse/ml",
            ["src/ccabs"; "src/ccparse"; "src/ccparse/gr"; "src/ccparse/tok"]);
          ("src/ccparse/gr",
            ["src/ccabs"; "src/ccparse"; "src/ccparse/ml"; "src/ccparse/tok"]);
          ("src/ccparse",
            [
               "src/ccabs";
               "src/ccparse/gr";
...
let dispatch_mine = function
  | After_rules ->
      ...
      rule "Compile C++ grammar to ML"
        ...
        begin fun env build ->
          Cmd(atomize (["/usr/local/bin/elkhound"; "-timing"; "-module-prefix"; "Cc"] @ grammars))
        end;
