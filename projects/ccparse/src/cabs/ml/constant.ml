...
type ustring = BatUTF8.t


let ustring_of_sexp sx = BatUTF8.adopt (string_of_sexp sx)
let sexp_of_ustring us = sexp_of_string (BatUTF8.to_string us)
...
let of_wstring s = WStringValue (BatUTF8.adopt s)
...
let to_wstring = function WStringValue v -> (BatUTF8.to_string v) | _ -> failwith "to_wstring"
