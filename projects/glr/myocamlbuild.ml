(* OASIS_START *)
(* DO NOT EDIT (digest: 5c213b7b5cbe9ede7e131d0581c46578) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [("glr", ["src/glr"]); ("gramanl", ["src/gramanl"])];
     lib_c = [];
     flags = [];
     includes =
       [
          ...
          ("src/gramanl/ml", ["src/glr"; "src/gramanl"]);
          ("src/gramanl", ["src/glr"; "src/gramanl/ml"]);
          ("src/glr/ml", ["src/glr"]);
          ("src/glr", ["src/glr/ml"]);
